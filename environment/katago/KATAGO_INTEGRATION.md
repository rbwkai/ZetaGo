...
The repo includes a KataGo layout under `environment/katago/`:

- `environment/katago/bin/katago` is the engine executable.
- `environment/katago/bin/default_gtp.cfg` is the default GTP config.
- `environment/katago/models/*.bin.gz` contains the neural net model file.
...
- `environment/katago/bin/katago`
- `environment/katago/bin/default_gtp.cfg`
- `environment/katago/models/*.bin.gz`
...
```bash
./environment/katago/bin/katago gtp -model ./environment/katago/models/<MODEL>.bin.gz -config ./environment/katago/bin/default_gtp.cfg
```
...
4. The bundled `environment/katago/bin` and `environment/katago/models` files provide the defaults.
